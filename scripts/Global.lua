...
colorToPlayer = {
   Red = {zone = "49a4e0",
      ...
      FC = { - 16.60, 1.82, - 23.70},
      SC = { - 13.40, 1.82, - 23.70},
      coin = {-49.00, 2.01, -42.44},
      AS1 = {-48.85, 1.89, -34.79},
      AS2 = {-45.69, 1.82, -34.79},
      AS3 = {-42.53, 1.82, -34.79},
      AS4 = {-39.37, 1.82, -34.79},
      D = {-52.43, 1.82, -40.80},
      L = {-39.37, 1.82, -40.80},
      equip = {-49.03, 1.82, -45.51},
      items = {-56.39, 1.82, -34.48}
   },
   White = {zone = "dac936",
      color = {1, 1, 1},
      pre = "P2",
      ...
      FC = { - 9.32, 1.82, - 23.70},
      SC = { - 6.15, 1.82, - 23.70},
      coin = {-25.37, 2.01, -42.44},
      AS1 = {-24.85, 1.82, -34.79},
      AS2 = {-21.69, 1.82, -34.79},
      AS3 = {-18.53, 1.82, -34.79},
      AS4 = {-15.37, 1.82, -34.79},
      D = {-28.43, 1.82, -40.80},
      L = {-15.37, 1.82, -40.80},
      equip = {-25.03, 1.82, -45.51},
      items = {-32.39, 1.82, -34.48}
   },
   Blue = {zone = "62cd94",
      color = {0.118, 0.53, 1},
      pre = "P3",
      ...
      D = {-4.43, 1.83, -40.80},
      L = {8.63, 1.82, -40.80},
      equip = {-1.03, 1.82, -45.51},
      items = {-8.39, 1.82, -34.48}
   },
   Green = {zone = "963318",
      ...
      FC = {13.41, 1.82, - 23.70},
      SC = {16.58, 1.82, - 23.70},
      coin = {23.63, 1.93, -42.44},
      AS1 = {23.15, 1.82, -34.79},
      AS2 = {26.31, 1.82, -34.79},
      AS3 = {29.47, 1.82, -34.79},
      AS4 = {32.63, 1.82, -34.79},
      D = {19.57, 1.82, -40.80},
      L = {32.63, 1.82, -40.80},
      equip = {22.97, 1.82, -45.51},
      items = {15.61, 1.82, -34.48}
   },
   Purple = {zone = "78094e",
      ...
      FC = {63.22, 1.82, -38.61},
      SC = {66.40, 1.82, -38.66},
      coin = {48.13, 2.01, -42.44},
      AS1 = {47.15, 1.82, -34.79},
      AS2 = {50.31, 1.82, -34.79},
      AS3 = {53.47, 1.82, -34.79},
      AS4 = {56.63, 1.82, -34.79},
      D = {43.57, 1.82, -40.80},
      L = {56.63, 1.81, -40.80},
      equip = {46.97, 1.82, -45.51},
      items = {39.62, 1.82, -34.48}
   },
   Black = {
